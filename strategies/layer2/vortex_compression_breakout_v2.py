...
logger = logging.getLogger("Syngex.Strategies.VortexCompressionBreakoutV2")
...
class VortexCompressionBreakoutV2(BaseStrategy):
    """
    ...
    strategy_id = "vortex_compression_breakout_v2"
    layer = "layer2"
