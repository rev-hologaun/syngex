...
logger = logging.getLogger("Syngex.Strategies.DepthDecayMomentumV2")

MIN_CONFIDENCE = 0.05


class DepthDecayMomentumV2(BaseStrategy):
    """
    ...
    strategy_id = "depth_decay_momentum_v2"
    layer = "layer2"
    ...
    def evaluate(self, data: Dict[str, Any]) -> List[Signal]:
        ...
        stop_pct = params.get("stop_pct", 0.007)
