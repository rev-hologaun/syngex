...
logger = logging.getLogger("Syngex.Strategies.ExchangeFlowConcentrationV2")

MIN_CONFIDENCE = 0.05


class ExchangeFlowConcentrationV2(BaseStrategy):
    """
    ...
    strategy_id = "exchange_flow_concentration_v2"
    layer = "layer2"
    ...
    def _vamp_validation(
        ...
        if direction == "LONG":
            return vamp_mid_dev >= -0.0005  # VAMP tolerance ±0.0005
        else:
            return vamp_mid_dev <= 0.0005  # VAMP tolerance ±0.0005
