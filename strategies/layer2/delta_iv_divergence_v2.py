...
logger = logging.getLogger("Syngex.Strategies.DeltaIVDivergenceV2")
...
class DeltaIVDivergenceV2(BaseStrategy):
    """
    ...
    strategy_id = "delta_iv_divergence_v2"
    layer = "layer2"
