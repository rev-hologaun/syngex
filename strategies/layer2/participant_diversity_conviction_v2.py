...
logger = logging.getLogger("Syngex.Strategies.ParticipantDiversityConvictionV2")
...
class ParticipantDiversityConvictionV2(BaseStrategy):
    """
    ...
    strategy_id = "participant_diversity_conviction_v2"
    layer = "layer2"
