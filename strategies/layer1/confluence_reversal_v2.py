...
logger = logging.getLogger("Syngex.Strategies.ConfluenceReversalV2")
...
POSITIVE_GAMMA_STOP_MULT = 0.50   # Tighter stops in positive gamma (cleaner)
...
class ConfluenceReversalV2(BaseStrategy):
    """
    ...
    strategy_id = "confluence_reversal_v2"
    layer = "layer1"
