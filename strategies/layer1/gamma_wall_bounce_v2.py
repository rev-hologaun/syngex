...
Exit:
    ...
    - Target: midpoint between walls or 2.0× risk
...
logger = logging.getLogger("Syngex.Strategies.GammaWallBounceV2")
...
class GammaWallBounceV2(BaseStrategy):
    ...
    strategy_id = "gamma_wall_bounce_v2"
    layer = "layer1"
