...
logger = logging.getLogger("Syngex.Strategies.GammaFlipBreakoutV2")
...
MIN_GAMMA_STRENGTH = 200         # Minimum |net_gamma| for regime confidence (normalized scale)

# Regime-adjusted stop multipliers
NEGATIVE_GAMMA_STOP_MULT = 2.5   # Wider stops in negative gamma (more noise)
POSITIVE_GAMMA_STOP_MULT = 0.50  # Tighter stops in positive gamma (less noise)


class GammaFlipBreakoutV2(BaseStrategy):
    """
    ...
    strategy_id = "gamma_flip_breakout_v2"
    layer = "layer1"
    ...
    def _fade_above_flip(
        ...
        Uses POSITIVE_GAMMA_STOP_MULT (0.50) for tighter stops.
        """
    ...
    def _short_fade(
        ...
        stop_mult = POSITIVE_GAMMA_STOP_MULT  # 0.50 — tighter in positive gamma
