...
logger = logging.getLogger("Syngex.Strategies.IVBandBreakoutV2")
...
class IVBandBreakoutV2(BaseStrategy):
    """
    ...
    strategy_id = "iv_band_breakout_v2"
    layer = "layer3"
    ...
    def _get_atm_strike(gex_calc: Any, price: float) -> Optional[float]:
        ...
        try:
            ...
            logger.debug("IVBandBreakoutV2: failed to get ATM strike: %s", exc)
            return None
