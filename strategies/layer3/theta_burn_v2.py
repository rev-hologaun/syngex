...
logger = logging.getLogger("Syngex.Strategies.ThetaBurnV2")
...
class ThetaBurnV2(BaseStrategy):
    """
    ...
    def _safe_get_walls(gex_calc: Any) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.debug("ThetaBurnV2: failed to get gamma walls: %s", exc)
            return []
